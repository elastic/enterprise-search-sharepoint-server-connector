...
def test_sharepoint(settings):
    ...
    configs, _ = settings
    logging.info("Starting SharePoint connectivity tests..")
    ...
    if not response:
        ...
        assert True
    logging.info("SharePoint connectivity tests completed..")
...
def test_workplace(settings):
    ...
    logging.info("Starting Workplace connectivity tests..")
    ...
    logging.info("Workplace connectivity tests completed..")
...
def test_ingestion(settings):
    ...
    configs, retry_count = settings
    enterprise_search_host = configs.get_value("enterprise_search.host_url")
    logging.info("Starting Workplace ingestion tests..")
    document = [
        {
            "id": 1234,
    ...
    logging.info("Workplace ingestion tests completed..")
